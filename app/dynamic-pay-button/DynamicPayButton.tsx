...
const Card = () => (
  <div
    className={cn(
      'card text-shadow-black/40 h-52 text-white text-shadow [perspective:1000px]',
    )}
  >
    <div
      className={cn(
        'card-inner h-full w-full transition-transform duration-[600ms] ease-[ease] [transform-style:preserve-3d]',
      )}
    >
      <div
        className={cn(
          ...
          'dark:from-[hsl(210,60%,20%)] dark:to-[hsl(210,60%,10%)]',
      ...
      >
        <div
          className={cn(
            'card-bg absolute -right-24 -top-5 bottom-0 w-full rounded-tl-[100%]',
            'bg-gradient-to-tl from-[#01adef] to-[#0860bf]',
            'dark:from-[hsl(210,60%,24%)] dark:to-[hsl(210,60%,9%)] dark:to-95%',
