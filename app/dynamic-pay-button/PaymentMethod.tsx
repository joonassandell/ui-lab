    ...
    <div>
      ...
      <label
        className={cn(
          ...
          'border-transparent bg-zinc-100 hover:border-zinc-300 hover:text-sky-700 peer-checked:border-blue-200 peer-checked:bg-sky-100 peer-checked:text-sky-700',
